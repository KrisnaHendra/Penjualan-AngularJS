app.controller("kasmasukCtrl", function ($scope, Data, $rootScope) {
    /**
     * Inialisasi
     */
    var tableStateRef;
    ...
    $scope.callServer = function callServer(tableState) {
        ...
        Data.get("kasmasuk/index", param).then(function (response) {
    ...
    $scope.create = function (form) {
        ...
        Data.get("kasmasuk/kode").then(function (result) {
            console.log(result);
            $scope.form.no_transaksi = "0" + result.data.id + "/KMS/00" + result.data.list.kode;
        });
        Data.get("kasmasuk/akun").then(function (response) {
            $scope.akuns = response.data;
        });
        Data.get("kasmasuk/kontak").then(function (response) {
    ...
    $scope.save = function (form) {
        ...
        Data.post("kasmasuk/save", form).then(function (result) {
    ...
    $scope.delete = function (row) {
        if (confirm("Apa anda yakin akan Menghapus item ini ?")) {
            row.is_deleted = 0;
            Data.post("kasmasuk/hapus", row).then(function (result) {
